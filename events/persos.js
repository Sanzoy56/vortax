...
const PERSOS = {
  gojo: {
    ...
    techniques: [
      ...
      { name: '🏴 Infinite Void',    cmd: '=territoire',        desc: 'Quiconque parle dans le salon perd 5000–8000 coins reversés à toi pendant 5 min · CD : 9j' },
...
async function handleAttack(msg, args, name, attUser, attChar) {
  ...
  switch (name) {
    ...
    case 'territoire': {
      ...
      return msg.reply(ok('🏴 **Infinite Void** — Le salon est ton territoire ! Quiconque y parle perd **5000–8000** ' + COIN + ' directement reversés dans ta poche pendant **5 minutes** !'));
    }
