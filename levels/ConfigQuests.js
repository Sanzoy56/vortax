...
const QUEST_POOL = [
  ...
  { id: 'evt_04', cat: 'EVT', label: 'Assidu',             desc: 'Maintenir ton streak',         type: 'streak',    target: 1,     rewardExp: 500,  rewardCoins: 2000  },
  ...
  { id: 'evt_10', cat: 'EVT', label: 'Streak x3',          desc: 'Avoir un streak de 3 jours',   type: 'streak',    target: 3,     rewardExp: 1000, rewardCoins: 4000  },
  { id: 'evt_11', cat: 'EVT', label: 'Streak x7',          desc: 'Avoir un streak de 7 jours',   type: 'streak',    target: 7,     rewardExp: 2000, rewardCoins: 8000  },
  ...
  { id: 'spe_09', cat: 'SPE', label: 'Vocal + streak',     desc: 'Rester 20 min en vocal et maintenir ton streak', type: 'combo_voc_streak', target: 1, rewardExp: 800, rewardCoins: 3200 },
